...
export const metadata: Metadata = {
  title: 'LED-scherm huren Oost-Vlaanderen - Snelle levering',
  description: 'LED-scherm huren in Oost-Vlaanderen? FlexLED levert mobiele LED-schermen in Gent, Aalst, Sint-Niklaas, Dendermonde en alle andere steden. Snelle levering, scherpe prijzen.',
}

const steden = [
  { naam: 'Gent', slug: 'gent', highlight: true },
  { naam: 'Aalst', slug: 'aalst', highlight: true },
  { naam: 'Sint-Niklaas', slug: 'sint-niklaas', highlight: true },
  { naam: 'Dendermonde', slug: 'dendermonde', highlight: true },
  { naam: 'Oudenaarde', slug: 'oudenaarde', highlight: true },
  { naam: 'Lokeren', slug: 'lokeren' },
  { naam: 'Wetteren', slug: 'wetteren' },
  { naam: 'Zele', slug: 'zele' },
  { naam: 'Temse', slug: 'temse' },
  { naam: 'Beveren', slug: 'beveren' },
  { naam: 'Ninove', slug: 'ninove' },
  { naam: 'Geraardsbergen', slug: 'geraardsbergen' },
  { naam: 'Ronse', slug: 'ronse' },
  { naam: 'Zottegem', slug: 'zottegem' },
  { naam: 'Eeklo', slug: 'eeklo' },
  { naam: 'Deinze', slug: 'deinze' },
  { naam: 'Hamme', slug: 'hamme' },
  { naam: 'Buggenhout', slug: 'buggenhout' },
  { naam: 'Lebbeke', slug: 'lebbeke' },
  { naam: 'Waasmunster', slug: 'waasmunster' },
  { naam: 'Kruibeke', slug: 'kruibeke' },
  { naam: 'Stekene', slug: 'stekene' },
  { naam: 'Destelbergen', slug: 'destelbergen' },
  { naam: 'Melle', slug: 'melle' },
  { naam: 'Merelbeke', slug: 'merelbeke' },
  { naam: 'De Pinte', slug: 'de-pinte' },
  { naam: 'Nazareth', slug: 'nazareth' },
  { naam: 'Gavere', slug: 'gavere' },
]
  ...
  return (
    <div>
      ...
      <section className="section">
        <div className="container-custom">
          ...
          <h1 className="page-title">
            LED-scherm huren in <span className="text-primary">Oost-Vlaanderen</span>
          </h1>
          <p className="page-subtitle">
            FlexLED levert mobiele LED-schermen in heel Oost-Vlaanderen. Van Gent tot Aalst, van Sint-Niklaas tot Oudenaarde - wij zijn er snel.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="local-usps">
            <div className="local-usp">
              ...
              <div>
                <strong>Heel Oost-Vlaanderen</strong>
                <span>Van Gent tot de Denderstreek</span>
              </div>
            </div>
            <div className="local-usp">
              <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="container-custom">
          ...
          <div className="cities-grid highlight">
            {highlightSteden.map((stad) => (
              <Link 
                key={stad.slug} 
                href={`/ledscherm-huren/oost-vlaanderen/${stad.slug}`}
      ...
      <section className="section bg-background-dark">
        <div className="container-custom">
          <h2 className="section-title">Alle steden in Oost-Vlaanderen</h2>
      ...
      <section className="section bg-background-dark">
        <div className="container-custom cta-section">
          <h2>LED-scherm nodig in Oost-Vlaanderen?</h2>
